...
public class WorldObjectComp_ConstructionSite : WorldObjectComp
{
        ...
        ref float hillinessModifier, ref float swampinessModifier, ref float bridgeModifier)
    {
        try
        {
            var settings = LoadedModManager.GetMod<RailsAndRoadsOfTheRim>()
                .GetSettings<RailsAndRoadsOfTheRimSettings>();
            ...
            elevationModifier = fromTile.elevation <= settings.CostIncreaseElevationThreshold
                ...
                : (fromTile.elevation - settings.CostIncreaseElevationThreshold) /
                  RailsAndRoadsOfTheRimSettings.ElevationCostDouble;
            ...
            hillinessModifier = hilliness / RailsAndRoadsOfTheRimSettings.HillinessCostDouble;
            swampinessModifier = swampiness / RailsAndRoadsOfTheRimSettings.SwampinessCostDouble;
        ...
        out Dictionary<string, int> rebate)
    {
        ...
        var bestExistingRoad = RailsAndRoadsOfTheRim.BestExistingRoad(fromTile_int, toTile_int);
        ...
        if (bestExistingRoadDefModExtension == null || roadToBuildRoadDefModExtension == null ||
            !RailsAndRoadsOfTheRim.IsRoadBetter(roadToBuild, bestExistingRoad))
        {
            return;
        }
        ...
        foreach (var resourceName in DefModExtension_RotR_RoadDef.allResourcesAndWork)
        {
            ...
            if ((int)(existingCost * (float)RailsAndRoadsOfTheRim.settings.CostUpgradeRebate / 100) > toBuildCost)
            {
            ...
            {
                rebate[resourceName] =
                    (int)(existingCost * (float)RailsAndRoadsOfTheRim.settings.CostUpgradeRebate / 100);
            }
        }
    }
    ...
    public static string CostModifersDescription(int fromTile_int, int toTile_int, ref float totalCostModifier)
    {
        ...
        var settings = LoadedModManager.GetMod<RailsAndRoadsOfTheRim>().GetSettings<RailsAndRoadsOfTheRimSettings>();
    ...
    public override void CompTick()
    {
        ...
        {
            RailsAndRoadsOfTheRim.DebugLog($"Construction Site CompTick. parentsite = {(RoadConstructionSite)parent}",
                e);
        }
    }
    ...
    public bool FinishWork(Caravan caravan = null)
    {
        ...
        if (parentSite != null)
        {
            ...
            if (fromTile.potentialRoads != null)
            {
                ...
                {
                    if ((aLink.neighbor == toTile_int) &
                        RailsAndRoadsOfTheRim.IsRoadBetter(parentSite.roadDef, aLink.road))
                    {
            ...
            {
                RailsAndRoadsOfTheRim.DebugLog("[RotR] Exception : ", e);
            }
        }
    ...
    public void EndConstruction(Caravan caravan = null)
    {
        ...
        {
            RailsAndRoadsOfTheRim.FactionsHelp.HelpFinished(parentSite.helpFromFaction);
        }
    }
