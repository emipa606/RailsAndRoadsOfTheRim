...
public class RoadConstructionSite : WorldObject
{
    ...
    public override IEnumerable<Gizmo> GetGizmos()
    {
        ...
        yield return RailsAndRoadsOfTheRim.RemoveConstructionSite(Tile);
    }
    ...
    private void PopulateDescription()
    {
        ...
        RailsAndRoadsOfTheRim.DebugLog(NeighbouringSettlementsDescription);
    ...
    private void SearchForSettlements(int startTile, ref List<SettlementInfo> settlementsSearched)
    {
        ...
        timer.Stop();
        RailsAndRoadsOfTheRim.DebugLog($"Time spent searching for settlements : {timer.ElapsedMilliseconds}ms");
    }
    ...
    public void TryToSkipBetterRoads(Caravan caravan = null)
    {
        ...
        var bestExistingRoad = RailsAndRoadsOfTheRim.BestExistingRoad(Tile, nextLeg.Tile);
        // We've found an existing road that is better than the one we intend to build : skip this leg and move to the next
        if (RailsAndRoadsOfTheRim.IsRoadBetter(roadDef, bestExistingRoad))
        {
            return;
        }
    ...
    */
    ...
    {
        if (RailsAndRoadsOfTheRim.RoadBuildingState.CurrentlyTargeting == this && roadDef != null
    ...
    {
        RailsAndRoadsOfTheRim.FactionsHelp.HelpFinished(helpFromFaction);
